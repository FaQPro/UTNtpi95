...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2023 a las 01:03:06
...
INSERT INTO `equipo` (`nombre`, `titulares`, `suplentes`, `directorTecnico`, `partidosJugados`, `puntos`, `estado`) VALUES
('Racing', 11, 6, 'Fernando Gago', 1, 0, 1),
('River', 11, 6, 'Marcelo Gallardo', 1, 3, 1);
...
INSERT INTO `puntaje` (`nombre`, `puntos`, `PG`, `PE`, `PP`) VALUES
('Racing', 0, 0, 0, 1),
('River', 3, 1, 0, 0);
